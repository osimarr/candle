...
extern "C" int hip_index_select_u32_f8e4m3(
    int ordinal,
    const uint8_t* src,
    const size_t* src_dims,
    const size_t* src_strides,
    ...
    uint8_t* dst,
    size_t elem_count) {
    return index_select<F8E4M3Storage>(
...
extern "C" int hip_index_select_i64_f8e4m3(
    int ordinal,
    const uint8_t* src,
    const size_t* src_dims,
    const size_t* src_strides,
...
extern "C" int hip_gather_u32_f8e4m3(
    int ordinal,
    const uint8_t* src,
    const size_t* src_dims,
    const size_t* src_strides,
...
extern "C" int hip_scatter_u32_f8e4m3(
    int ordinal,
    int add,
    uint8_t* dst,
    const size_t* dst_dims,
...
extern "C" int hip_index_add_u32_f8e4m3(
    int ordinal,
    const uint8_t* input,
    const size_t* input_dims,
    const size_t* input_strides,
    ...
    uint8_t* dst,
    size_t elem_count) {
    return index_add<F8E4M3Storage>(
